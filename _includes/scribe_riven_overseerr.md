Riven can use Overseerr as a content source. This guide illustrates how to retrieve your API key from Overseerr, and add it to Riven, so that Riven is able to scrape the current requests from Overseerr
